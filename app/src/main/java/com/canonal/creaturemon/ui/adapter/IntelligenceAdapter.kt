...
class IntelligenceAdapter(
    ...
    private val values: List<IntelligenceType>
) : ArrayAdapter<IntelligenceType>(context, layoutResource, values) {

    override fun getItem(position: Int): IntelligenceType = values[position]
    ...
    private fun bindData(value: IntelligenceType, view: TextView): TextView {
